...
class Thread extends BaseThread
{
	...
	/**
	 * @ORM\OneToMany(targetEntity="Fogs\MessageBundle\Entity\Message", mappedBy="thread")
	 */
	protected $messages;

	/**
	 * @ORM\OneToMany(targetEntity="Fogs\MessageBundle\Entity\ThreadMetadata", mappedBy="thread", cascade={"all"})
	 */
	protected $metadata;
